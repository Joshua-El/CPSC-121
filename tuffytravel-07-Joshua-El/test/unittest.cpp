...
TEST(CheckedRoute, Inheritance) {
  ...
  ASSERT_NE(your_route, nullptr) << "The CheckedRoute class should inherit from the Route class.";
}

TEST(CheckedRoute, AccessorsMutators) {
  CheckedRoute your_checked_route;
  your_checked_route.set_take_off_time(1111);
  ASSERT_EQ(your_checked_route.take_off_time(), 1111) << "Hint: The mutator was used to set the take off time to 1111 so the accessor needs to return the same value.";
}

TEST(CheckedRoute, NonDefaultConstructor) {
  CheckedRoute your_checked_route("Delta LAX-ATL", 535, 635, 1101);
  ASSERT_EQ(your_checked_route.name(), "Delta LAX-ATL") << "Hint: The nondefault constructor should have set the name of the route to Delta LAX-ATL.";
  ASSERT_EQ(your_checked_route.departure_time(), 535) << "Hint: The nondefault constructor should have set the departure time of the route to 535";
  ASSERT_EQ(your_checked_route.take_off_time(), 635) << "Hint: The nondefault constructor should have set the take off time of the route to 635";
  ASSERT_EQ(your_checked_route.arrival_time(), 1101) << "Hint: The nondefault constructor should have set the arrival time of the route to 1101";
}

TEST(CheckedRoute, DefaultConstructor) {
  CheckedRoute your_checked_route;
  ASSERT_EQ(your_checked_route.name(), "Home") << "Hint: The default name of the route should be Home.";
  ASSERT_EQ(your_checked_route.departure_time(), 2000) << "Hint: The default departure time of the route should be 2000";
  ASSERT_EQ(your_checked_route.take_off_time(), 2010) << "Hint: The default constructor should have set the take off time of the route to 2010";
  ASSERT_EQ(your_checked_route.arrival_time(), 2200) << "Hint: The default arrival time of the route should be 2200";
}

TEST(CheckedRoute, Display) {
  CheckedRoute* your_checked_route = new CheckedRoute("Delta LAX-ATL", 535, 635, 1101);
  ASSERT_DURATION_LE(3, {
    SIMULATE_SIO("", your_checked_route->display(), {
      ASSERT_THAT(your_output, HasSubstr("Delta LAX-ATL"))
        << "Hint: The member function should display the checked route's name, Delta LAX-ATL, on the screen.";
      ASSERT_THAT(your_output, HasSubstr("535"))
        << "Hint: The member function should display the checked route's departure time, 535, on the screen.";
      ASSERT_THAT(your_output, HasSubstr("635"))
        << "Hint: The member function should display the checked route's take off time, 635, on the screen.";
      ASSERT_THAT(your_output, HasSubstr("1101"))
        << "Hint: The member function should display the checked route's arrival time, 1101, on the screen.";
    })
  })
...
TEST(CheckedRoute, SaveString) {
  CheckedRoute* your_checked_route = new CheckedRoute("Delta LAX-ATL", 535, 635, 1101);
  ASSERT_THAT(your_checked_route->save_string(), HasSubstr("[CheckedRoute]")) << "Hint: The member function should return the type of the route, [CheckedRoute].";
  ASSERT_THAT(your_checked_route->save_string(), HasSubstr("Delta LAX-ATL"))
    << "Hint: The member function should return the checked route's name, Delta LAX-ATL, on the screen.";
  ASSERT_THAT(your_checked_route->save_string(), HasSubstr("535"))
    << "Hint: The member function should return the checked route's departure time, 535, on the screen.";
  ASSERT_THAT(your_checked_route->save_string(), HasSubstr("635"))
      << "Hint: The member function should return the checked route's take off time, 635, on the screen.";
  ASSERT_THAT(your_checked_route->save_string(), HasSubstr("1101"))
    << "Hint: The member function should return the checked route's arrival time, 1101, on the screen.";
  delete your_checked_route;
}
...
TEST(Route, SaveString) {
  Route* your_route = new Route("57x Brea Mall Xpress", 1623, 1637);
  ASSERT_THAT(your_route->save_string(), HasSubstr("[Route]")) << "Hint: The member function should return the type of the route, [Route].";
  ASSERT_THAT(your_route->save_string(), HasSubstr("57x Brea Mall Xpress"))
    << "Hint: The member function should return the route's name, 57x Brea Mall Xpress, on the screen.";
  ASSERT_THAT(your_route->save_string(), HasSubstr("1623"))
    << "Hint: The member function should return the route's departure time, 1623, on the screen.";
  ASSERT_THAT(your_route->save_string(), HasSubstr("1637"))
    << "Hint: The member function should return the route's arrival time, 1637, on the screen.";
  delete your_route;
}
...
TEST(CreateCheckedRoute, CheckName) {
  ...
  ASSERT_EQ(your_checked_route->name(), "Delta LAX-ATL") << "Hint: The function should assign Delta LAX-ATL as the name for the CheckedRoute object.";
  delete your_checked_route;
}
...
TEST(CreateCheckedRoute, CheckDepartureTime) {
  ...
  ASSERT_EQ(your_checked_route->departure_time(), 535) << "Hint: The function should assign 535 as the departure time for the CheckedRoute object.";
  delete your_checked_route;
}
...
TEST(CreateCheckedRoute, CheckTakeOffTime) {
  ...
  ASSERT_EQ(your_checked_route->take_off_time(), 635) << "Hint: The function should assign 635 as the arrival time for the CheckedRoute object.";
  delete your_checked_route;
}
...
TEST(CreateCheckedRoute, CheckArrivalTime) {
  ...
  ASSERT_EQ(your_checked_route->arrival_time(), 1101) << "Hint: The function should assign 1101 as the take off time for the CheckedRoute object.";
  delete your_checked_route;
}
...
TEST_F(DisplayRoutes, MultipleRoutes) {
  ...
  ASSERT_DURATION_LE(3, {
    SIMULATE_SIO("", your_route_manager.display_routes(), {
      ...
      ASSERT_THAT(your_output, HasSubstr("Delta LAX-ATL"))
        << "Hint: The member function should display the second routes' name";
      ASSERT_THAT(your_output, HasSubstr("1642"))
        << "Hint: The member function should display the second routes' departure time.";
        ASSERT_THAT(your_output, HasSubstr("1742"))
          << "Hint: The member function should display the second routes' take off time.";
      ASSERT_THAT(your_output, HasSubstr("2250"))
        << "Hint: The member function should display the second routes' arrival time.";

      ASSERT_THAT(your_output, HasSubstr("1648"))
        << "Hint: The member function should display the third routes' departure time.";
      ASSERT_THAT(your_output, HasSubstr("1702"))
        << "Hint: The member function should display the third routes' arrival time.";
    })
  })
}
...
TEST_F(SaveFile, OneRoute) {
  ...
  ASSERT_EQ(your_file_route_type, "[Route]") << "      The function should save the type of the first route to be [Route]";
...
TEST_F(SaveFile, ThreeRoutes) {
  ...
  ASSERT_EQ(your_file_size, 3)  << "      The function should store 3 for the number of routes in the file.";
  ...
  // second route
  std::getline(your_file, your_file_route_type);
  ASSERT_EQ(your_file_route_type, "[CheckedRoute]") << "      The function should save the type of the first route to be [CheckedRoute]";

  std::getline(your_file, your_file_route_name);

  ASSERT_EQ(your_file_route_name, "Delta LAX-ATL") << "      The function should save the name of the second route, Delta LAX-ATL";

  your_file >>your_file_departure_time;

  ASSERT_EQ(your_file_departure_time, 1642) << "      The function should save the departure time of the second route, 1642";

  your_file >>your_file_takeoff_time;
  your_file.ignore();

  ASSERT_EQ(your_file_takeoff_time, 1742) << "      The function should save the take off time of the second route, 1742";

  your_file >>your_file_arrival_time;
  your_file.ignore();

  ASSERT_EQ(your_file_arrival_time, 2250) << "      The function should save the arrival time of the second route, 2250";
  ...
  ASSERT_EQ(your_file_route_name, "57x Brea Mall Xpress") << "      The function should save the name of the third route, 57x Brea Mall Xpress";

  your_file >>your_file_departure_time;

  ASSERT_EQ(your_file_departure_time, 1648) << "      The function should save the departure time of the third route, 1648";

  your_file >>your_file_arrival_time;

  ASSERT_EQ(your_file_arrival_time, 1702) << "      The function should save the arrival time of the third route, 1702";
...
TEST(LoadFile_, NoFile) {
  ...
  SIMULATE_SIO("", {
    ...
    ASSERT_THAT(your_output, HasSubstr("does not exist")) << "      The function should show an error if the file to be loaded does not exist.";
  })
}
...
TEST_F(DriverSaveFile, CreateCreateCheckedSaveExit) {
  ...
  // second route
  std::getline(your_file, your_file_route_type);
  ASSERT_EQ(your_file_route_type, "[CheckedRoute]") << "      The program should save the type of the first route to be [CheckedRoute]";

  std::getline(your_file, your_file_route_name);

  ASSERT_EQ(your_file_route_name, "Delta LAX-ATL") << "      The program should save the name of the second route, Delta LAX-ATL";

  your_file >>your_file_departure_time;

  ASSERT_EQ(your_file_departure_time, 535) << "      The program should save the departure time of the second route, 535";

  your_file >>your_file_takeoff_time;
  your_file.ignore();

  ASSERT_EQ(your_file_takeoff_time, 635) << "      The program should save the take off time of the second route, 635";

  your_file >>your_file_arrival_time;
  your_file.ignore();

  ASSERT_EQ(your_file_arrival_time, 1101) << "      The function should save the arrival time of the second route, 1101";
